...
cmd = %Q{$HOME/Documents/inis/ios-sim launch "#{app_test_host}" #{environment_args} --args -SenTest All 2>&1 | tee "#{test_output_path}" }
cmd.gsub! "iphoneos", "iphonesimulator"
puts "** Launcher path ios-sim: $HOME/Documents/inis/ios-sim"
